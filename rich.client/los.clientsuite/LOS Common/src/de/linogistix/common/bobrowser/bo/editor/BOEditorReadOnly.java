...
/**
 * Editor for displaying a value of type BasicEntity from a BOQueryTopComponent.
 * 
 * @author <a href="http://community.mywms.de/developer.jsp">Andreas Trautmann</a>
 */
public class BOEditorReadOnly extends PropertyEditorSupport implements ExPropertyEditor {

    private Logger log = Logger.getLogger(BOEditorReadOnly.class.getName());
    private BOEntityNodeReadOnly boBeanNode;
...
//                    value = bo.getQueryService().queryById(e.getId());
                    this.setBoBeanNode(new BOEntityNodeReadOnly(e));
...
//        log.info("drawing: " + getAsText());
    ...
    public Component getCustomEditor() {
        try {
            if (getEntity() == null) {
                ...
                BOEditorPanel panel = new BOEditorPanel(new BOEntityNodeReadOnly(getEntity()));
    ...
    public BOEntityNodeReadOnly getBoBeanNode() {
        return boBeanNode;
    }
    ...
    public void setBoBeanNode(BOEntityNodeReadOnly boBeanNode) {
