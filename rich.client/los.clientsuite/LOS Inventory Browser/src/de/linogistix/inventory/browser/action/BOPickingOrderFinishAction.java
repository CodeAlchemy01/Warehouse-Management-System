 ...
 * @author krane
 */
public final class BOPickingOrderFinishAction extends NodeAction {
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        NotifyDescriptor d = new NotifyDescriptor.Confirmation(
                NbBundle.getMessage(InventoryBundleResolver.class, "NotifyDescriptor.ReallyFinishOrder"),
        ...
        try {
            ...
            for (Node n : activatedNodes) {
                ...
                pickingFacade.finishOrder(order.getId());
            }
