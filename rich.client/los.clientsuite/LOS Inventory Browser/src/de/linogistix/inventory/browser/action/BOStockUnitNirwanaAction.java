...
public final class BOStockUnitNirwanaAction extends NodeAction {

    private static final Logger log = Logger.getLogger(BOStockUnitNirwanaAction.class.getName());
   private static String[] allowedRoles = new String[]{
        Role.ADMIN.toString(),Role.INVENTORY_STR,Role.FOREMAN_STR
    };

    public String getName() {
        return NbBundle.getMessage(InventoryBundleResolver.class, "sendStockUnitsToNirwana");
    }
