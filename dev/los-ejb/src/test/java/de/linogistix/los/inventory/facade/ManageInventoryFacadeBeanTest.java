    ...
    public void testManageInventory() throws Exception {
    	...
    	try{
	        ...
	        bean.createAvis(CommonTestTopologyRemote.TESTCLIENT_NUMBER,
	                TEST_ITEM, TEST_LOT, new BigDecimal(1000), today.getTime());
	        
	        bean.createAvis(CommonTestTopologyRemote.TESTCLIENT_NUMBER,
	                InventoryTestTopologyRemote.ITEM_A1_NUMBER, InventoryTestTopologyRemote.LOT_N1_A1_NAME, new BigDecimal(100000), today.getTime());
	        
	        bean.createAvis(CommonTestTopologyRemote.TESTCLIENT_NUMBER,
	                InventoryTestTopologyRemote.ITEM_A1_NUMBER, TEST_LOT_X, new BigDecimal(7000),today.getTime());
